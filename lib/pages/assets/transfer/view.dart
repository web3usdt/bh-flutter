        ...
        (context, index) {
          ...
          return <Widget>[
            ...
            <Widget>[
              ...
              TextWidget.body(
                  '${item.drawOutDirection == 'UserWallet' ? '资金账户'.tr : item.drawOutDirection == 'ContractAccount' ? '合约账户'.tr : item.drawOutDirection == 'gameAccount' ? '游戏账户'.tr : '挖矿账户'.tr}  - ${item.intoDirection == 'UserWallet' ? '资金账户'.tr : item.intoDirection == 'ContractAccount' ? '合约账户'.tr : item.intoDirection == 'gameAccount' ? '游戏账户'.tr : '挖矿账户'.tr}',
                  size: 26.sp,
