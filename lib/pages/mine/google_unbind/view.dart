...
class GoogleUnbindPage extends GetView<GoogleUnbindController> {
  const GoogleUnbindPage({super.key});
  ...
  Widget build(BuildContext context) {
    return GetBuilder<GoogleUnbindController>(
      init: GoogleUnbindController(),
      id: "google_unbind",
      builder: (_) {
        return Scaffold(
