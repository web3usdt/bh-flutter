  ...
  Widget _buildHeader() {
    return <Widget>[
      <Widget>[
        ...
        <Widget>[
          TextWidget.body(
            '${controller.currentCoin.increaseStr}',
            size: 24.sp,
            color: AppTheme.color000,
            weight: FontWeight.w600,
          ),
      ...
      <Widget>[
        TextWidget.body(
          '24h${'量'.tr} ${controller.currentCoin.vol}',
          size: 22.sp,
          color: AppTheme.color000,
        ),
        SizedBox(height: 10.w),
        TextWidget.body(
          '24h${'高'.tr} ${controller.currentCoin.high}',
          size: 22.sp,
          color: AppTheme.color000,
        ),
        SizedBox(height: 10.w),
        TextWidget.body(
          '24h${'低'.tr} ${controller.currentCoin.low}',
          size: 22.sp,
          color: AppTheme.color000,
        ),
        ...
        .tight(width: 690.w, height: 160.w);
  }
            ...
            <Widget>[
              ...
              for (var item in controller.buyList ?? [])
                <Widget>[
                  ...
                  TextWidget.body(MathUtils.omitTo(item.amount ?? '0', 2), size: 20.sp, color: AppTheme.color000).positioned(left: 0, top: 5.w),
