...
import 'package:happy/pages/assets/withdraw_setup/index.dart';
import 'package:happy/pages/game/game_assets_record/index.dart';
import 'package:happy/pages/game/game_detail/index.dart';
import 'package:happy/pages/game/hash_game/index.dart';
import 'package:happy/pages/game/hash_game_detail/index.dart';
import 'package:happy/pages/login/remove_google/index.dart';

// 各模块页面引入（可按模块折叠管理）
import 'package:happy/pages/login/start/index.dart';
import 'package:happy/pages/login/login/index.dart';
import 'package:happy/pages/login/register/index.dart';
import 'package:happy/pages/login/download_app/index.dart';
import 'package:happy/pages/login/forgot_password/index.dart';
import 'package:happy/pages/login/forgot_password/bindings.dart';
import 'package:happy/pages/login/network_diagnosis/index.dart';

import 'package:happy/pages/tab/main/index.dart';
import 'package:happy/pages/tab/main/binding.dart';

import 'package:happy/pages/home/notice_list/index.dart';
import 'package:happy/pages/home/notice_detail/index.dart';
import 'package:happy/pages/home/k_chart_socket/index.dart';
import 'package:happy/pages/home/contract_k_chart_socket/index.dart';
import 'package:happy/pages/home/subscribe/index.dart';
import 'package:happy/pages/home/subscribe_record/index.dart';

import 'package:happy/pages/assets/recharge/index.dart';
import 'package:happy/pages/assets/withdraw/index.dart';
import 'package:happy/pages/assets/transfer/index.dart';
import 'package:happy/pages/assets/assets_record/index.dart';
import 'package:happy/pages/assets/withdraw_address/index.dart';
import 'package:happy/pages/assets/withdraw_address_edit/index.dart';

import 'package:happy/pages/mine/userinfo/index.dart';
import 'package:happy/pages/mine/setup/index.dart';
import 'package:happy/pages/mine/switch_account/index.dart';
import 'package:happy/pages/mine/edit_password/index.dart';
import 'package:happy/pages/mine/share/index.dart';
import 'package:happy/pages/mine/theme/index.dart';
import 'package:happy/pages/mine/customer_server/view.dart';
import 'package:happy/pages/mine/customer_server/index.dart';
import 'package:happy/pages/mine/google/index.dart';
import 'package:happy/pages/mine/google_bind/index.dart';
import 'package:happy/pages/mine/google_unbind/index.dart';
import 'package:happy/pages/mine/realname/index.dart';
import 'package:happy/pages/mine/realname_aws/index.dart';
import 'package:happy/pages/mine/realname_aws_status/index.dart';
import 'package:happy/pages/mine/realname_list/index.dart';
import 'package:happy/pages/mine/develop_mode/index.dart';

import 'package:happy/pages/coin/my_authorize/index.dart';
import 'package:happy/pages/contract/my_authorize/index.dart';
import 'package:happy/pages/option/option_buy/index.dart';
import 'package:happy/pages/option/option_buy_record/index.dart';

import 'package:happy/pages/mining/my_mining/index.dart';
import 'package:happy/pages/mining/mining_output/index.dart';
import 'package:happy/pages/mining/mining_record/index.dart';
import 'package:happy/pages/mining/team/index.dart';
import 'package:happy/pages/mining/network/index.dart';
import 'package:happy/pages/mining/get_power/index.dart';
