...
class UserShareRecordModel {
  ...
  factory UserShareRecordModel.fromJson(Map<String, dynamic> json) {
    return UserShareRecordModel(
      ...
      referralType: DataUtils.toStr(json['referral_type']),
